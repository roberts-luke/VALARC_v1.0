...
ijbox=$($CDFPATH/cdffindij -c mesh.nc -p T -w -170 -130 70.5 80.5 | tail -2 | head -1)
...
$CDFPATH/cdfmean -f $FILEOUT -v sobarstf -p T -w ${ijbox} 0 0 -minmax -o BFGy_$FILEOUT
ncatted -a valid_min,max_sobarstf,d,, -a valid_max,max_sobarstf,d,, BFGy_$FILEOUT
